...
public class MoppyUI {
    ...
    protected void startup() {
        ...
        mainWindow.setStatus("Initialisation...");
        mainWindow.setVisible(true);
        mainWindow.setStatus("Prêt...");
    ...
    public Object getPreferenceObject(String key) {
        try {
            ...
            Logger.getLogger(MoppyUI.class.getName()).log(Level.WARNING, "Aucune préférence définie pour " + key, ex);
        } catch (IOException ex) {
            Logger.getLogger(MoppyUI.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(MoppyUI.class.getName()).log(Level.SEVERE, null, ex);
