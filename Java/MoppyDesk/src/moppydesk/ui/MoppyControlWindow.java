    ...
    implements KeyEventDispatcher
{
    ...
    private void initComponents() {
        ...
        mainStatusLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        mainStatusLabel.setText("Chargé.");
        mainStatusLabel.setToolTipText("Statut");
        ...
        inputSelectBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fichier MIDI", "Entrée MIDI", "Playlist" }));
        ...
        connectButton.setToolTipText("Enregistre les paramètres de sortie et se connecte au port selectionner.");
        ...
        jLabel2.setText("FloppyMusic créer par StoneSet");
        jLabel2.setToolTipText("Basé sur le code de MoppyDESK");
    ...
    private void connect() {
        try {
            ...
            setStatus("Initialisation des récepteurs...");
            initializeReceivers();                      
            app.rm.connecting();
            ...
            connectButton.setText("Déconnecté");
            setStatus("Connecté.");
        } catch (Exception ex) {
    ...
    private void connectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectButtonActionPerformed
        ...
        if (connectButton.getText().equals("Connecté")) {
            connect();
        } else {
            disconnect();
        }
